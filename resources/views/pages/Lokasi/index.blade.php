            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center" id="ch">
                        ...
                        <a class="btn btn-primary ml-auto btn-sm" href="{{route('lokasi.create')}}">
                        ...
                        <table id="jenisBarang" class="display table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr style="white-space:nowrap; width:1%;">
                                    ...
                                    <td>{{$L->detail_lokasi}}</td>
                                    
                                    <td>
                                        <a href="{{route('lokasi.edit', $L->id)}}" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Data">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <button id="removeL" data-id="{{ $L->id }}" data-toggle="tooltip" title="" class="btn btn-link btn-danger show_confirm" data-original-title="Hapus Data">
