                    ...
                    <div class="row">
                            <div class="col-md-6 col-lg-5">
                               <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_memo" value="@if(!empty(old('id_memo'))){{ old('id_memo') }}@endif" class="form-control  input-full @error('id_memo') is-invalid @enderror" id="id_memo" disabled>
                                    @error('id_memo')
