                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" enctype="multipart/form-data" action="{{ route('Keluarga.import') }}" id="myForm">
                                ...
                                <div class="modal-footer">
                                    <a href="{{asset('templateExcel/Template Import Data Keluarga.xlsx')}}" class="btn btn-success btn-sm text-white">Download Template</a>
    ...
    $(document).ready(function() {
        $('#tabelKeluarga').DataTable({
            ...
            initComplete: (settings, json) => {
                $('#tabelKeluarga_paginate').appendTo('#pagination');
                $('#tabelKeluarga_filter').appendTo('#search');
                $('#tabelKeluarga_length').appendTo('#show_page');
            },
        });
    });
