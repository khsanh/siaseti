                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input name="kode_organisasi" value="@if(!empty(old('kode_organisasi'))){{ old('kode_organisasi') }}@endif" type="text" class="form-control @error('kode_organisasi') is-invalid @enderror" id="kode_organisasi" @if($errors->has('kode_organisasi')) autofocus @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="level_organisasi" value="@if(!empty(old('level_organisasi'))){{ old('level_organisasi') }}@endif" type="text" class="form-control @error('level_organisasi') is-invalid @enderror" list="level_organisasis" id="level_organisasi" @if($errors->has('level_organisasi')) autofocus @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- <input name="nama_pejabat" value="@if(!empty(old('nama_pejabat'))){{ old('nama_pejabat') }}@endif" type="text" class="form-control @error('nama_pejabat') is-invalid @enderror" id="nama_pejabat" list="pejabats" @if($errors->has('nama_pejabat')) autofocus @endif> -->
                                    <select name="nama_pejabat" type="text" class="form-control @error('nama_pejabat') is-invalid @enderror" id="nama_pejabat" @if($errors->has('nama_pejabat')) autofocus @endif>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input name="nama_organisasi" value="@if(!empty(old('nama_organisasi'))){{ old('nama_organisasi') }}@endif" type="text" class="form-control @error('nama_organisasi') is-invalid @enderror" id="nama_organisasi" list="nama_organisasis" @if($errors->has('nama_organisasi')) autofocus @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="status" value="@if(!empty(old('status'))){{ old('status') }}@endif" type="text" class="form-control @error('status') is-invalid @enderror" id="status" list="statuss" @if($errors->has('status')) autofocus @endif>
                                    <datalist id="statuss">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="status_pejabat" value="@if(!empty(old('status_pejabat'))){{ old('status_pejabat') }}@endif" type="text" class="form-control @error('status_pejabat') is-invalid @enderror" list="status_pejabats" id="status_pejabat" @if($errors->has('status_pejabat')) autofocus @endif>
