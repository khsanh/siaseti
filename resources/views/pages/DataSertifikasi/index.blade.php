...
<div class="page-inner">
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{route('Sertifikasi.index')}}">Data Sertifikasi</a>
            </li>
        </ul>
    </div>
    <div class="row">
                ...
                <div class="card-header">
                    <div class="d-flex align-items-end">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="{{route('Sertifikasi.export')}}">
                                <button class="btn btn-primary ml-1 btn-sm">
                                    <i class="fas fa-file-export"></i>
                                    Eksport Data
                                </button>
                            </a>
                            <a class="btn btn-primary ml-1 btn-sm" href="{{route('Sertifikasi.create')}}">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Import Data Sertifikasi</h4>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <form method="POST" enctype="multipart/form-data" action="{{ route('Sertifikasi.import') }}" id="myForm">
                                {{ csrf_field() }}
                                ...
                                <div class="modal-footer">
                                    <a href="{{asset('templateExcel/Template Import Data Sertifikasi.xlsx')}}" class="btn btn-success btn-sm text-white">Download Template</a>
                        ...
                        <table id="tabelSertifikasi" class="display table table-hover">
                            <thead>
                                <tr>
                                    <th>NIP</th>
                                    <th>Nama Lengkap</th>
                                    <th>Jumlah Keikutsertaan Sertifikasi</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td style="white-space:nowrap; width:1%;">{{$sertifikasi->nip}}</td>
                                    <td style="white-space:nowrap; width:1%;">{{$sertifikasi->nama}}</td>
                                    <td style="white-space:nowrap; width:1%;">{{$sertifikasi->jumlah}}</td>
                                    <td style="white-space:nowrap; width:1%;">
                                        <div class="form-button-action">
                                            <a href="{{route('Sertifikasi.list', $sertifikasi->id_pegawai)}}" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary" data-original-title="Lihat Data">
                                                <i class="fas fa-info-circle"></i>
                                            </a>
                                            <button type="button" data-id="{{$sertifikasi->id_pegawai}}" id="remove" data-toggle="tooltip" title="" class="btn btn-link btn-danger deletesertifikasi" data-original-title="Hapus Sertifikasi">
