                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <!-- <select name="id_detail_aset" class="form-control form-control @error('id_detail_aset') is-invalid @enderror" required id="id_detail_aset">
                                        <option value="{{$da->id}}" {{ $da->id }}>{{$da->kode_aset}}</option>
                                    </select> -->
                                    <input type="text" class="form-control" value="{{$da->kode_aset}}" disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label for="id_penanggung_jawab">Pengguna Aset Saat Ini</label>
                                    <select name="id_penanggung_jawab" class="form-control f0 @error('id_penanggung_jawab') is-invalid @enderror" required id="id_penanggung_jawab">
                                        <option value="">---Pilih---</option>
                                        @foreach($pj as $pj)
                                        <option value="{{$pj->id}}">{{$pj->nip}} - {{$pj->nama}}</option>
                                        @endforeach
                                    </select>
                                    <span class="invalid-feedback a0" role="alert">
                                        <strong>Pilih Pengguna Aset Dulu!!!</strong>
                                    </span>
